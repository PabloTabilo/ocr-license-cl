...
| **Hito**                    | **Tarea**|Check|
|------------------------------|------------------------------------------------------------------|--|
| Finalizar Pila Tecnológica   | - Evaluar pros y contras entre SQL y MongoDB para la base de datos.|SQL|
|                              | - Revisar opciones para hosting y GPUs (AWS, Azure, GCP).|PENDIENTE|
|                              | - Tomar decisiones finales sobre herramientas para frontend y backend.|B-python,fastapi,pytorch F-javascript,reactNative|
